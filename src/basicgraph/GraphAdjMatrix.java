...
public class GraphAdjMatrix extends Graph {
	...
	public List<Integer> getDistance2(int v) {
		List<Integer> oneHopDistance = getNeighbors(v);
		List<Integer> twoHopDistance = new ArrayList<>();
		for(Integer n : oneHopDistance){
			twoHopDistance.addAll(getNeighbors(n));
		}
		return twoHopDistance;
	}
